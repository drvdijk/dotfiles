...
# Delay for spring loaded directories (0=none)
...
for view in 'Desktop' 'Standard'; do
    ...
    /usr/libexec/PlistBuddy -c "Set :${view}ViewSettings:IconViewSettings:gridSpacing 83" ~/Library/Preferences/com.apple.finder.plist

    # Icon size
    /usr/libexec/PlistBuddy -c "Set :${view}ViewSettings:IconViewSettings:iconSize 40" ~/Library/Preferences/com.apple.finder.plist
